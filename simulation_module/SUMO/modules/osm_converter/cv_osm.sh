#!/bin/bash
# Edit these
project="Haines_City" # The file name of the .osm (w/o the .osm)
prj_dir="../" # Directory where you want the files places
begin=0 # Begin time of simulation
end=30000 # End time of simulation
