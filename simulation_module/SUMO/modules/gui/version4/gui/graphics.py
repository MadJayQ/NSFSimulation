...
# Added by Quentin Goss
# Lets graphics.py and tkinter simply be placed together into a module.
s_abs_path = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0,s_abs_path + "/tkinter")
# End edit
