...
s_route_file = s_absolute_path + "/../data/Haines_City.rou.xml"
s_sumocfg_file = s_absolute_path + "/../data/Haines_City_geo.sumocfg"
s_net_file = s_absolute_path + "/../data/Haines_City.net.xml"
n_time_steps = 10000
